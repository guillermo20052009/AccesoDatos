...
# Corregir selección de y_pred_sample para evitar el error de índices
y_pred_sample = y_pred[df_test_sample.index.to_numpy() - df_test.index[0]]

# Ordenar los datos por rebotes para que la línea de tendencia se vea correctamente
...
# Datos reales (azul)
plt.scatter(x_test_sample, y_test_sample, color='blue', marker='o', label='Datos Reales')

# Predicción (naranja)
plt.scatter(x_test_sample, y_pred_sample, color='orange', marker='x', label='Predicción')
